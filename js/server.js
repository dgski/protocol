...
(function(global, factory) { /* global define, require, module */
    ...
    $root.ChunkNeeded = (function() {
    
        /**
         * Properties of a ChunkNeeded.
         * @exports IChunkNeeded
         * @interface IChunkNeeded
         * @property {string|null} [id] ChunkNeeded id
         */
    
        /**
         * Constructs a new ChunkNeeded.
         * @exports ChunkNeeded
         * @classdesc Represents a ChunkNeeded.
         * @implements IChunkNeeded
         * @constructor
         * @param {IChunkNeeded=} [properties] Properties to set
         */
        function ChunkNeeded(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * ChunkNeeded id.
         * @member {string} id
         * @memberof ChunkNeeded
         * @instance
         */
        ChunkNeeded.prototype.id = "";
    
        /**
         * Creates a new ChunkNeeded instance using the specified properties.
         * @function create
         * @memberof ChunkNeeded
         * @static
         * @param {IChunkNeeded=} [properties] Properties to set
         * @returns {ChunkNeeded} ChunkNeeded instance
         */
        ChunkNeeded.create = function create(properties) {
            return new ChunkNeeded(properties);
        };
    
        /**
         * Encodes the specified ChunkNeeded message. Does not implicitly {@link ChunkNeeded.verify|verify} messages.
         * @function encode
         * @memberof ChunkNeeded
         * @static
         * @param {IChunkNeeded} message ChunkNeeded message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ChunkNeeded.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
        ...
        /**
         * Encodes the specified ChunkNeeded message, length delimited. Does not implicitly {@link ChunkNeeded.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ChunkNeeded
         * @static
         * @param {IChunkNeeded} message ChunkNeeded message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ChunkNeeded.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ChunkNeeded message from the specified reader or buffer.
         * @function decode
         * @memberof ChunkNeeded
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ChunkNeeded} ChunkNeeded
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ChunkNeeded.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChunkNeeded();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ChunkNeeded message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ChunkNeeded
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ChunkNeeded.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ChunkNeeded message.
         * @function verify
         * @memberof ChunkNeeded
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ChunkNeeded.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.id != null && message.hasOwnProperty("id"))
        ...
        /**
         * Creates a ChunkNeeded message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ChunkNeeded
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ChunkNeeded} ChunkNeeded
         */
        ChunkNeeded.fromObject = function fromObject(object) {
            if (object instanceof $root.ChunkNeeded)
                return object;
            var message = new $root.ChunkNeeded();
            if (object.id != null)
        ...
        /**
         * Creates a plain object from a ChunkNeeded message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ChunkNeeded
         * @static
         * @param {ChunkNeeded} message ChunkNeeded
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ChunkNeeded.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this ChunkNeeded to JSON.
         * @function toJSON
         * @memberof ChunkNeeded
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ChunkNeeded.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
